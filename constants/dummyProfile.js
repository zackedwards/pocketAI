...
export const trendingmodules = [
    {
        id: 1,
        module: "Text Generator",
        image: require("../assets/images/Text_Generator.jpg"),
        amount: "293 quireres",
        changes: "+6.24%",
        type: "I",      // I - Increased, D - Decreased
        description: "Text Generator module allows users to enter quires, and with the help of pocketAI, get an insightful, revelvant, correct response. The more you use it, the more efficent and effective pocketAI will be.",
        chartData: [
            { x: 1, y: 2 },
            { x: 2, y: 3 },
            { x: 3, y: 2 },
